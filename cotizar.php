			...
			<main class="flex justify-center">
				<div class="card">
					<div class="card-header">
						<span class="card-title"> Cotizar envio </span>
						<div class="spacer"></div>
							...
							<div class="flex gap-1">
								<div class="form-field">
									<label for="recoleccion"
										>Recolección del paquete</label
									>
									<select
										id="recoleccion"
										v-model="envio.recoleccion"
									>
							...
							>
								<div class="flex flex-column flex-1">
									...
									<div
										...
										v-if="envio.recoleccion === 'sucursal'"
									>
										<div class="form-field inline">
											<label for="origennombre"
												>Su nombre:</label
											>
											<input
												type="text"
												v-model="envio.origen.nombre"
											/>
										</div>
										<div class="form-field inline">
											<label for="sucursal"
									...
									<div class="flex flex-column gap-2" v-else>
										...
										<div class="form-field inline">
											<label for="origenestado"
												>Estado:</label
											>
											<select
												id="origenestado"
												v-model="envio.origen.estado"
											>
												<option :value="'cdmx'">
													CDMX
												</option>
										...
										<div class="form-field inline">
											...
											<input
												type="text"
												v-model="envio.origen.cp"
												if="origencp"
												maxlength="5"
											/>
										</div>
										<div class="form-field inline">
											<label for="origencolonia"
												>Colonia:</label
											>
											<input
												type="text"
										...
										<div class="form-field inline">
											<label for="origencalle"
												>Calle:</label
											>
											<input
												type="text"
												id="origencalle"
												v-model="envio.origen.calle"
											/>
										</div>
										<div class="form-field inline">
											<label for="origennumero"
												>Número:</label
											>
											<input
												id="origennumero"
												type="text"
												v-model="envio.origen.numero"
											/>
										</div>
									</div>
								</div>
								<div class="flex flex-column flex-1">
									...
									<div class="flex flex-column gap-2">
										<div class="form-field inline">
											<label for="destinonombre"
												>Nombre del destinatario:</label
											>
											<input
												type="text"
												v-model="envio.destino.nombre"
											/>
										</div>
										<div class="form-field inline">
											<label for="destinoestado"
												>Estado:</label
											>
											<select
												id="destinoestado"
												v-model="envio.destino.estado"
											>
												<option :value="'cdmx'">
													CDMX
												</option>
										...
										<div class="form-field inline">
											...
											<input
												type="text"
												v-model="envio.destino.cp"
												if="destinocp"
												maxlength="5"
											/>
										</div>
										<div class="form-field inline">
											<label for="destinocolonia"
												>Colonia:</label
											>
											<input
												type="text"
										...
										<div class="form-field inline">
											<label for="destinocalle"
												>Calle:</label
											>
											<input
												type="text"
												id="destinocalle"
												v-model="envio.destino.calle"
											/>
										</div>
										<div class="form-field inline">
											<label for="destinonumero"
												>Número:</label
											>
											<input
												id="destinonumero"
												type="text"
												v-model="envio.destino.numero"
											/>
										</div>
									</div>
								</div>
